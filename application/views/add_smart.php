        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-lg-10 col-lg-offset-1" data-form-type="formoid">
                    ...
                    <?php echo isset($data)? form_open_multipart('smart/proses_edit/', '', array('id_smart'=>$data[0]['id'])) : form_open_multipart('smart/proses_add/');?>
                        ...
                        <div class="row row-sm-offset">
                            ...
                            <div class="col-md-3 col-xs-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="datepicker" class="form-control" name="tgl" value="<?php echo isset($data)? $data[0]['tgl']:'';?>" placeholder="<?php echo date('d-m-Y', time());?>" readonly >
                                </div>
                            </div>
                        </div>    
                        ...
                        <div class="row row-sm-offset">    
                            ...
                            <div class="col-md-4 col-xs-4">
                                  <input type="file" class="form-control" name="gmb1">
                            </div>
                            <div class="col-md-4 col-xs-4">
                                  <input type="file" class="form-control" name="gmb2">
                            </div>
                        </div>    
                        ...
                        <div class="row row-sm-offset">    
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="index-form1-0-phone">Video</label>
                                    <input type="text" class="form-control" name="yt" placeholder="masukkan link beserta embednya">
                                </div>
                            </div>
                        </div>
